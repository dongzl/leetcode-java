...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/leetcode-java/flexsearch.min.js');loadScript('/leetcode-java/en.search-data.min.d14f0f6d5b204672efd341915b8adc2cb928a528540637ea9d3d964424df8dba.js',function(){input.required=false;search();});}
