...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/leetcode-java/flexsearch.min.js');loadScript('/leetcode-java/en.search-data.min.b5ff967600bb73bc68031edf9cc2d9cba0932923f9ef28ec21e59dfc77f306d1.js',function(){input.required=false;search();});}
