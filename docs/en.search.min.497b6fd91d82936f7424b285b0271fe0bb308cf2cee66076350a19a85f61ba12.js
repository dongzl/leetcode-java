...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/leetcode-java/flexsearch.min.js');loadScript('/leetcode-java/en.search-data.min.ff7e1b86fc6b3fb7a97a16fd20b7dcb81edf2f87f5425d1fc46ee5ef5785d98c.js',function(){input.required=false;search();});}
