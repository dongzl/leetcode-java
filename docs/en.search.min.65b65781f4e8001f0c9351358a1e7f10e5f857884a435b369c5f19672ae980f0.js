...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/leetcode-java/flexsearch.min.js');loadScript('/leetcode-java/en.search-data.min.f013cbfbcb321cf1152f8e09e5fac09d58e6ed6d0548538ed7f7785eb18d01b4.js',function(){input.required=false;search();});}
