...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/leetcode-java/flexsearch.min.js');loadScript('/leetcode-java/en.search-data.min.b64f63420256fdea9b5a3cdb4d56b52bddc9b5e49854dd93a726e57e90e08c5e.js',function(){input.required=false;search();});}
