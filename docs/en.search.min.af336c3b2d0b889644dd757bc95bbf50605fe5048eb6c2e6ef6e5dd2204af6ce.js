...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/leetcode-java/flexsearch.min.js');loadScript('/leetcode-java/en.search-data.min.903ba8706f0e7a2d56f0a20caa353f1135d0ea94233bb818c22ef64281007bd6.js',function(){input.required=false;search();});}
