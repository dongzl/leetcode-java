...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/leetcode-java/flexsearch.min.js');loadScript('/leetcode-java/en.search-data.min.4c6fc267e95a8bc84ee52f43e4b894fbc2a92134fbc80f534270a99624fe3e93.js',function(){input.required=false;search();});}
