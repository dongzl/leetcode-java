...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/leetcode-java/flexsearch.min.js');loadScript('/leetcode-java/en.search-data.min.e6ab94924c9ddf6a313f9b8ea1d0b0e67d4f03f496734d6bdd3a480efe57e1f9.js',function(){input.required=false;search();});}
