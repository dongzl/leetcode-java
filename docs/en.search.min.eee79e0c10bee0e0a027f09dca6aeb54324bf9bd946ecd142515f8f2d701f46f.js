...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/leetcode-java/flexsearch.min.js');loadScript('/leetcode-java/en.search-data.min.972da4dca0b1949de504898ba97c2a9565df471a15a5d7f79887d083a3340ee5.js',function(){input.required=false;search();});}
