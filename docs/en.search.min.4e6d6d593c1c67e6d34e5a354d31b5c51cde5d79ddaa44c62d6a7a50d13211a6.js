...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/leetcode-java/flexsearch.min.js');loadScript('/leetcode-java/en.search-data.min.8a0e215a97e9c8fcf60d6be42fbf776e009cca7c1e65781c7e5ddebb846d0528.js',function(){input.required=false;search();});}
