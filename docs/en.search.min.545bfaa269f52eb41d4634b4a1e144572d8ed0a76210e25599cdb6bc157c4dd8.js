...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/leetcode-java/flexsearch.min.js');loadScript('/leetcode-java/en.search-data.min.8273d0a00a2d0a29e802a261ba8ab18ba99f0454f9ed44720e6fdb2fe95dd517.js',function(){input.required=false;search();});}
