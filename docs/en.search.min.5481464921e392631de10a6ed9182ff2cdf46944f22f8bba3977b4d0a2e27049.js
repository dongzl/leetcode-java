...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/leetcode-java/flexsearch.min.js');loadScript('/leetcode-java/en.search-data.min.00490b4ce39091f00e5dbc3cb37de1bf1269f62e2e442397e270bfe1e1cc75ba.js',function(){input.required=false;search();});}
