...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/leetcode-java/flexsearch.min.js');loadScript('/leetcode-java/en.search-data.min.f3c7635e80ea89cc89176fae47b8cfe0fe5ad207bf67ff3e2c235fdd491982f9.js',function(){input.required=false;search();});}
