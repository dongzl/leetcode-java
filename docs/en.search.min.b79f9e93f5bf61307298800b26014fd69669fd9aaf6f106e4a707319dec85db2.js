...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/leetcode-java/flexsearch.min.js');loadScript('/leetcode-java/en.search-data.min.c4e3e7b997ce8dc741393d9bd6545444e4ac033d387c90dc6d55f4eb1f1fd1ce.js',function(){input.required=false;search();});}
